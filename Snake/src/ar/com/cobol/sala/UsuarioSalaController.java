...
import ar.com.cobol.database.DataBaseHelper;
import ar.com.cobol.hibernate.Sala;
import ar.com.cobol.hibernate.Usuario;
...
public class UsuarioSalaController extends DataBaseHelper {
	...
	public static List<Sala> BuscarSalasPublicas(String nombreUsuario) { //Se buscan las salas publicas
		...
		Session sesion = DataBase.crearSession();		
		try {
